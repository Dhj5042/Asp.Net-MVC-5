...
namespace Practical_12_2.Data.App_Data
{
	...
	public partial class DesignationDbContextDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteDesignation(Designation instance);
		...
		public DesignationDbContextDataContext() : 
				base(global::Practical_12_2.Data.Properties.Settings.Default.masterConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public DesignationDbContextDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DesignationDbContextDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DesignationDbContextDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DesignationDbContextDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void Ondesignation_nameChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_designation_name", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
